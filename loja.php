...
$camisas = array(
   ['name' => 'camisa 01', 'image' => 'uploads/tb-img-01.jpeg', 'price' => 55.9],
   ['name' => 'camisa 02', 'image' => 'uploads/tb-img-02.jpeg', 'price' => 45.9],
   ['name' => 'camisa 03', 'image' => 'uploads/tb-img-03.jpeg', 'price' => 65]
);
?>
   ...
   <nav class="navbar navbar-light bg-danger">
      <div class="container">
         <a class="navbar-brand" href="#">
            <img src="./imagens/nova-logo.png" alt="" width="50" height="50" class="d-inline-block align-text-top">
         </a>
      </div>
   </nav>
